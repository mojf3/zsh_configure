...
export PATH="/home/mojf/software/vim/bin:$PATH"
...
__conda_setup="$('/home/mojf/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/mojf/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/mojf/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/mojf/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
